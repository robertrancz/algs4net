/******************************************************************************
 *  File name :  BSTTests.cs
 *  Purpose   :  Contains basic unit tests for the BST class
 *
 ******************************************************************************/
using algs4net;
using System;
...
namespace algs4net.Test
{
    ...
    public class BSTTests
    {
        ...
        public void BSTTest2()
        {
            ...
            BST<int, string> st = new BST<int, string>();
            st[99] = null;
            ...
            BST<int, int> st2 = new BST<int, int>();
            st2[3] = 22;
            st2[2] = 33;
            st2[99] = 44;
            st2[2] = 55;
        ...
        public void BSTTest3()
        {
            ...
            BST<int, char> bst = new BST<int, char>();
            int[] keys = new int[32];
            for (int i = 0; i < keys.Length; i++)
            {
                keys[i] = i * 2;
