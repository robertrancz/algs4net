...
namespace algs4net
{
    ...
    public class Edge : IComparable<Edge>
    {
        ...
        {
            if (vertex == Either) return w;
            else if (vertex == w) return Either;
        ...
        public override string ToString()
        {
            if (double.IsNaN(Weight))
                return string.Format("{0}-{1}", Either, w);
            else
                return string.Format("{0}-{1} {2:F5}", Either, w, Weight);
        }
