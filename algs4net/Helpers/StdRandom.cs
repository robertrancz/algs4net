...
namespace algs4net
{
    ...
    /// random numbers from various discrete and continuous distributions,
    /// including Bernoulli, uniform, Gaussian, exponential, pareto, Poisson, and Cauchy.
    /// It also provides method for shuffling an array or subarray.</summary>
